...
CROSS JOIN (VALUES
  ...
  (11, 'El mapa de tu corrida',
      'El recorrido de cada salida en el mapa, con el ritmo tramo a tramo y la reproducción del trayecto.',
      '/screenshots/athlix/socio-mapa.png', 'socio'),
  (12, 'Tu rutina de gimnasio',
      'La rutina que le armó su coach: días, ejercicios, series, reps y peso, listos para entrenar.',
      '/screenshots/athlix/socio-rutina-gym.png', 'socio'),
  (13, 'Tu progreso',
      'Meta semanal, récords por distancia y comparación semana a semana. Todo lo que corriste, medido.',
      '/screenshots/athlix/socio-progreso.png', 'socio'),
  (14, 'Medallas y logros',
      'Medallas que suben de metal según tus marcas y suman logros: motivación que engancha y fideliza.',
      '/screenshots/athlix/socio-medallas.png', 'socio'),
  (15, 'Su perfil',
